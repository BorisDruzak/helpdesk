...
CORE_ENABLED_MODULES = ("system", "screen", "diag_logs")
...
class Settings(BaseModel):
    ...
    enabled_modules: List[str] = Field(default_factory=lambda: list(CORE_ENABLED_MODULES), description="Список включенных модулей (базовая комплектация: system, screen, diag_logs)")
