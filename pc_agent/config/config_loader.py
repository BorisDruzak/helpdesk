...
class ServerConfig(BaseModel):
    ...
    ws_url: str = Field(default="ws://example.test:8666/ws", description="URL WebSocket сервера")
    api_url: str = Field(default="http://example.test:8666/api", description="URL API сервера")
