# AGENTS.md — инструкции для Codex и Cursor (pc_agent)
...
- При изменении структуры агентского кода, точек входа или runtime-потоков **обязательно** обновлять `pc_agent/docs/CODEMAP.md`. Критерии — в конце файла и в `.cursor/rules/codemap.mdc`.
