...
TOPICS: tuple[Topic, ...] = (
    ...
    Topic(
        ...
        summary="Ticket-bound WebRTC Remote Assist: operator request, mandatory user consent through Maria Agent, retained non-blocking Qt consent dialogs, short-lived signaling tokens, dedicated signaling WebSocket, view-only screen sharing by default, smooth 1280x720@15fps profile for responsive control, explicit recvonly browser offers, failed WebRTC timeout cleanup, policy-gated interactive/elevated control over the WebRTC control data channel with sequential input processing, explicit single/double-click commands and a Windows UAC helper for elevated_admin, coturn REST-style ICE credential generation, audit rows, ticket timeline events and resolution passport summary.",
        aliases=(
            "remote assist",
            "remote_assist",
            "remote access",
