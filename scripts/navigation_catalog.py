...
TOPICS: tuple[Topic, ...] = (
    ...
    Topic(
        ...
        summary="P1 service desk process catalog: first-class helpdesk services and service offerings linked to request templates/form schemas, optional CMDB registry service links, publication gates, requester/agent-safe catalog projection, catalog-aware ticket create/preview, service/offering policy inheritance, Policy Health integration and service/offering reporting dimensions.",
        aliases=(
            "service catalog",
            "service-catalog",
            "service offering",
