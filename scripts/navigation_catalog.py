...
TOPICS: tuple[Topic, ...] = (
    ...
    Topic(
        ...
        summary="React/Vite `webapp`, typed `/api/web/*` contracts, session-gated `/app/*` routes, bundle serving from aiohttp, support Playwright signoff and typed admin slices for inventory, device update actions, observer quick summary and trace drilldown surfaces.",
        aliases=(
            "webapp",
            "react app",
            "vite",
