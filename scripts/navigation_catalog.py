...
TOPICS: tuple[Topic, ...] = (
    ...
    Topic(
        ...
        summary="Lightweight registry for people, departments, buildings/rooms, PC/printer assets, services, vendors and support queues; agent handshake auto-creates PC assets, requester profile sync creates people/locations/departments, and ticket detail/admin UI expose registry context.",
        aliases=(
            "registry",
            "registries",
            "assets",
