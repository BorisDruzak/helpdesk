...
TOPICS: tuple[Topic, ...] = (
    ...
    Topic(
        ...
        checks=(
            ...
            "python -m pytest pc_agent/tests/test_knowledge_suggestions.py pc_agent/tests/test_chat_panel_helpers.py -q --tb=short",
            "pnpm --dir webapp run build",
            "Browser signoff at https://192.168.100.17:9443/admin for /app/admin/knowledge/import, /app/admin/knowledge, /app/knowledge, /app/help and /app/tickets/:ticketId after deploy",
        ),
        plan_required=True,
        docs_to_update=(
            "server/docs/KNOWLEDGE_PLATFORM.md",
