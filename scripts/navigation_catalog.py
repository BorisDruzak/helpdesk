...
TOPICS: tuple[Topic, ...] = (
    ...
    Topic(
        ...
        summary="Single path for tool execution, typed support tool actions, support-safe tool policy metadata labels, metadata-driven consent approval, operation queueing, agent-side execution lanes and module execution tracing.",
        aliases=(
            "run_tool",
            "tool_call_started",
            "admin_run_tool",
