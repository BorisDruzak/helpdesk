...
TOPICS: tuple[Topic, ...] = (
    ...
    Topic(
        ...
        suggested_commands=(
            ...
            "python -m pytest server/tests/test_knowledge_contract_no_db.py server/tests/test_knowledge_repo.py server/tests/test_knowledge_api.py server/tests/test_knowledge_content_packs.py server/tests/test_knowledge_operations.py -q --tb=short",
        ...
        checks=(
            "python scripts/verify_workspace.py",
            "python -m pytest server/tests/test_knowledge_contract_no_db.py server/tests/test_knowledge_migration.py server/tests/test_knowledge_repo.py server/tests/test_knowledge_visibility.py server/tests/test_knowledge_acl_hardening.py server/tests/test_knowledge_search.py server/tests/test_knowledge_suggestions.py server/tests/test_knowledge_feedback.py server/tests/test_knowledge_graph.py server/tests/test_knowledge_ingestion.py server/tests/test_knowledge_passport_draft.py server/tests/test_knowledge_api.py server/tests/test_ticket_knowledge_links_compat.py server/tests/test_knowledge_metrics.py server/tests/test_knowledge_publish_flow.py server/tests/test_knowledge_db_constraints.py server/tests/test_knowledge_content_packs.py server/tests/test_knowledge_operations.py -q --tb=short",
            "python -m pytest pc_agent/tests/test_knowledge_suggestions.py pc_agent/tests/test_chat_panel_helpers.py -q --tb=short",
            "pnpm --dir webapp run build",
