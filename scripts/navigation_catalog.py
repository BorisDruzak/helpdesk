...
TOPICS: tuple[Topic, ...] = (
    ...
    Topic(
        ...
        suggested_commands=(
            ...
            "python -m pytest server/tests/test_registry_people_merge.py server/tests/test_registry_bulk_actions.py server/tests/test_registry_import_export.py -q",
