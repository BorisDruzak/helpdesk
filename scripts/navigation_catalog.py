...
TOPICS: tuple[Topic, ...] = (
    ...
    Topic(
        ...
        suggested_commands=(
            ...
            "pnpm --dir webapp test -- src/features/knowledge/api.test.ts src/features/knowledge/ai-settings-page.test.tsx src/features/knowledge/search-settings-page.test.tsx src/app/navigation.test.ts",
