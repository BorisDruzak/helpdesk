...
TOPICS: tuple[Topic, ...] = (
    ...
    Topic(
        ...
        summary="P2/P2.1/P2.2 universal knowledge platform: spaces, universal knowledge items, explicit selected-version publish flow, chunks/search foundation, service/offering/request-template bindings, PostgreSQL graph nodes/edges with DB enum constraints, ingestion jobs, feedback/deflection metrics, requester/agent-safe suggestions, idempotent content packs, templates/lint, first-class review tasks, quality scores, persisted Service Catalog gap findings, privacy-preserving search analytics, self-service rollout policies, support knowledge panel integration, existing kb_links compatibility, ACL-filtered direct reads/graph/ingestion/metrics/operations and stale passport-to-knowledge publish governance.",
        aliases=(
            "knowledge platform",
            "knowledge",
            "knowledge_items",
