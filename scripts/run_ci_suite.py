...
DEFAULT_SERVER_PYTEST_TIMEOUT_SECONDS = 2 * 60 * 60
...
def _fixture_builder_audit_command(workspace: Path) -> list[str]:
    return [
        sys.executable,
        str(workspace / "scripts" / "audit_fixture_builders.py"),
        "--workspace",
        str(workspace),
        "--strict",
    ]
