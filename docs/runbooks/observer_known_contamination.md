...
Current TD-011 review on 2026-06-24 keeps only three narrow historical rows time-boxed until 2026-07-24: `device_outbox.id=135`, `p0:phantom_malformed_rows` and `p6:historical_non_p6_agent_offline_active`.
