...
| Problem Management | `server/problem/*`, `server/web_api/problem_handlers.py`, `server/app/db/migrations/versions/*problem_management*`, `server/docs/PROBLEM_MANAGEMENT.md`, `webapp/src/features/problems/*`, `webapp/src/pages/admin/problems-page.tsx`, `webapp/src/pages/tickets/list-page.tsx` | Problem candidates from quality/ticket/knowledge/SLA signals, problem lifecycle, RCA, known-error/workaround Knowledge links, affected objects, problem analytics and ticket-problem links | `/api/web/problems*`, `/api/web/problem-candidates*`, support ticket linked-problems panel, `/app/admin/problems`; requester-safe known errors/workarounds only through Knowledge Platform publish | problem contract/service/API/privacy/analytics/scanner tests, ticket problem link tests, webapp problem API/workspace tests, webapp build, P2.3 layered CI, browser signoff for admin problem workspace and support ticket linked-problems panel |
