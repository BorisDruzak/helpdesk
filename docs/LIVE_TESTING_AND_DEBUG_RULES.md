...
This file is a compatibility entrypoint for prompts and workflows that reference
`docs/LIVE_TESTING_AND_DEBUG_RULES.md`.

The canonical project rules live in:
...
Do not duplicate or edit the rule body here. Update
`docs/LIVE_TESTING_DEBUG_RULES.md` when the live testing/debug policy changes.
