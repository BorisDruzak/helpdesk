...
| Server UI / admin pages | `server/admin.js`, `server/tech/handlers.py`, `server/ticket.js`, `server/static_pages/`, `server/routes.py` | `server/docs/CODEMAP.md` | `python scripts/diff_context.py`, затем browser check через MCP на `http://192.168.100.17:8666/admin` |
