...
| Tickets / chat / queue | `server/tickets/handlers.py`, `server/tickets/create_flow.py`, `server/tickets/workflow_service.py`, `server/chat/`, `server/api/events.py` | `server/docs/TICKET_SYSTEM.md`, `server/docs/CHAT_MESSAGE_CONTRACT.md`, `server/docs/CODEMAP.md` | `python scripts/agent_find.py "ticket" --dir server`, `python scripts/agent_find.py "since_event_id" --dir server`, `python scripts/agent_find.py "before_event_id" --dir server`, `python scripts/agent_find.py "chat_raise" --dir server` |
