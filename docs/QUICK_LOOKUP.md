...
| Agent updates / launcher | `server/agents/agent_builds_handlers.py`, `server/websocket/agent_handshake.py`, `pc_agent/launcher/installer.py`, `pc_agent/ws_agent.py` | `server/docs/AGENT_UPDATES_API.md`, `pc_agent/docs/SELF_UPDATE.md`, `pc_agent/docs/PROTOCOL_V3.md` | `python scripts/agent_find.py "agent_update" --dir server`, `python scripts/agent_find.py "pending_update" --dir pc_agent` |
