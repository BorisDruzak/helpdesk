"""Disable UI logins linked to inactive registry people by any ui_login identity.

Revision ID: 126
Revises: 125
Create Date: 2026-06-19 14:18:00
"""
...
def upgrade() -> None:
    ...
    op.execute(
        ...
        SELECT d.user_login,
               ...
               'migration_126',
               jsonb_build_object(
                   'reason', 'migration_existing_registry_person_inactive_any_ui_login_identity',
                   'revoked_ui_tokens', (
