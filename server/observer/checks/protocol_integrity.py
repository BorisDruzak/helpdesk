    ...
    if not ack_audits:
        events.append(
            ObserverIntegrityEventInput(
                ...
                expected="Protocol V3 ACK emission should have durable persistence audit for ACK/persistence correlation.",
                actual=f"No ACK persistence audit event was found in the last {int(lookback.total_seconds() // 3600)} hours.",
                evidence={
