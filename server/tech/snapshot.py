...
def collect_config_values() -> dict[str, Any]:
    return {
        ...
        "AUTH_ALLOW_QUERY_TOKEN": _bool_config("AUTH_ALLOW_QUERY_TOKEN", True),
        "AUTH_UI_DB_USERS_ENABLED": _bool_config("AUTH_UI_DB_USERS_ENABLED", True),
        "AUTH_UI_CONFIG_FALLBACK_ENABLED": _bool_config("AUTH_UI_CONFIG_FALLBACK_ENABLED", True),
        "PILOT_MIN_AGENT_VERSION": _str_config("PILOT_MIN_AGENT_VERSION"),
        "WEB_SESSION_COOKIE_SECURE": _bool_config("WEB_SESSION_COOKIE_SECURE", False),
