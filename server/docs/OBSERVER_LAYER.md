...
- `/app/admin/observer` trace detail must lead with `explanation`: launch source, actor, tool/module/preset label, human error diagnosis, launch path and next actions. Technical spans, UUIDs and raw attrs stay available below this summary.
