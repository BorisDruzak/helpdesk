...
| `server/web_api/registry_handlers.py` | Typed registry endpoints: `GET /api/web/admin/registry` для страницы `/app/admin/registry` и `POST /api/registry/profile` для agent GUI profile sync |
