...
| `server/tickets/smart_views.py` | Backend saved-view catalog and matcher for support queue slices such as `sla_risk`, `ola_risk`, `unassigned`, requester replies, stale waits, waiting approval and diagnostics failed |
