...
- **playbook / diagnostic scenarios** — `playbook_handlers.py`, `playbooks/catalog.py`, `playbooks/form_triggers.py`, `app/services/playbook_engine.py`, `app/services/playbook_scheduler.py`, `app/repos/playbook_repo.py`, `web_api/admin_handlers.py`, `webapp/src/features/playbooks/*`, `server/docs/DIAGNOSTIC_PLAYBOOKS.md`
