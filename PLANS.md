...
- оценка готовности первой большой волны после realtime bridge: примерно `80%`; остаются финализация живых Linux-checks для этого слоя, точечная дочистка admin/support realtime drilldown и следующий пласт legacy cleanup/cutover подготовки.
