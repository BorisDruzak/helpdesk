...
- Done, live stand: create/publish/bind article and verify requester/support suggestions over service/offering/request-template context (`artifacts/browser_live_validation/knowledge-studio-k3-bfd74491-helpdesk-binding-1781480733685/summary.json`).

Exit bar:

- Done, live evidence: article appears in relevant request/support contexts.
