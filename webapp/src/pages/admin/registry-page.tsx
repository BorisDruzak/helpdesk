        ...
        <CardContent className="space-y-4">
          ...
          {tab === "assets" ? (
            <div className="overflow-hidden rounded-lg border border-border">
              <div className="grid grid-cols-[minmax(180px,1.4fr)_minmax(150px,1fr)_minmax(160px,1fr)_120px_120px] gap-3 bg-slate-50 px-4 py-3 text-xs font-semibold uppercase text-slate-500">
                <span>Объект</span>
                <span>Владелец</span>
                <span>Место</span>
                <span>Тикеты</span>
              ...
              {(visibleRegistry?.assets ?? []).length ? (
                visibleRegistry?.assets.map((asset) => (
                  <div className="grid grid-cols-[minmax(180px,1.4fr)_minmax(150px,1fr)_minmax(160px,1fr)_120px_120px] gap-3 border-t border-border px-4 py-3 text-sm" key={asset.id}>
                    <div>
